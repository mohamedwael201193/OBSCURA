...
function activityUrl(eventName: string): string {
  ...
  if (eventName.startsWith("ObscuraVote.") || eventName.startsWith("ObscuraGovernor.")
    || eventName.startsWith("ObscuraTreasury.") || eventName.startsWith("ObscuraRewards.")) return `${FRONTEND_URL}/vote`;
