        ...
        <div className="space-y-6">
            ...
            {!isConnected ? (
              ...
              <div className="space-y-2">
                {[1, 2].map((i) => (
                  <div
                    key={i}
                    className="h-14 bg-secondary/30 rounded-md animate-pulse"
                  />
                ))}
              </div>
            ) : permits.length === 0 ? (
              ...
              <div className="space-y-2">
                {permits.map((permit, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 bg-secondary/30 rounded-md border border-border/30"
                  >
                    <div>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono text-red-400 border border-red-500/20 rounded-md hover:bg-red-500/10 transition-colors"
                    >
          ...
          >
            ...
            <div className="space-y-3">
              <div className="p-4 bg-secondary/30 rounded-md border border-border/30">
          ...
          >
            ...
            <div className="mt-4 p-3 bg-secondary/10 rounded-md border border-border/20">
