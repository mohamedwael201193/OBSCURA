    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <h3 className="font-display text-lg text-foreground leading-tight">My Policies</h3>
        </div>
          ...
          <div key={i} className="rounded-xl bg-white/[0.025] border border-white/[0.07] p-3 space-y-2">
            ...
            {p.txHash && (
              <a href={`https://sepolia.arbiscan.io/tx/${p.txHash}`} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-[11px] text-foreground/60 hover:text-foreground transition-colors">
