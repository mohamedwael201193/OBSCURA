/**
 * EncryptedValue — professional FHE-encrypted balance display tile.
 *
 * Three visual states:
 ...
 *
 * Design mirrors CUSDCPanel's encrypted balance pattern from Pay.
 */
import { motion, AnimatePresence } from "framer-motion";
import { ShieldCheck, Eye, Loader2, Lock } from "lucide-react";

interface Props {
  /** The decrypted bigint value, or null if still encrypted / not yet revealed. */
  value: bigint | null;
  /** True while the decrypt permit/operation is in flight. */
  loading?: boolean;
  ...
  className?: string;
  /** Display label shown above the value (e.g. "Your Supply"). */
  label?: string;
  /** Accent colour theme: "cyan" | "emerald" | "violet" | "amber" (default "cyan"). */
